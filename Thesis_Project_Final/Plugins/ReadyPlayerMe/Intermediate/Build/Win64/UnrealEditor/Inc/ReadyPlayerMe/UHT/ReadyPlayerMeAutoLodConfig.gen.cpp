...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UReadyPlayerMeAutoLodConfig_Statics::NewProp_AutoLodConfigs = { "AutoLodConfigs", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UReadyPlayerMeAutoLodConfig, AutoLodConfigs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReadyPlayerMeAutoLodConfig_Statics::NewProp_AutoLodConfigs_MetaData), Z_Construct_UClass_UReadyPlayerMeAutoLodConfig_Statics::NewProp_AutoLodConfigs_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UReadyPlayerMeAutoLodConfig_Statics::NewProp_LODScreenSizes = { "LODScreenSizes", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UReadyPlayerMeAutoLodConfig, LODScreenSizes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReadyPlayerMeAutoLodConfig_Statics::NewProp_LODScreenSizes_MetaData), Z_Construct_UClass_UReadyPlayerMeAutoLodConfig_Statics::NewProp_LODScreenSizes_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeAutoLodConfig_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeAutoLodConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReadyPlayerMeAutoLodConfig, UReadyPlayerMeAutoLodConfig::StaticClass, TEXT("UReadyPlayerMeAutoLodConfig"), &Z_Registration_Info_UClass_UReadyPlayerMeAutoLodConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReadyPlayerMeAutoLodConfig), 972255643U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeAutoLodConfig_h_183469550(TEXT("/Script/ReadyPlayerMe"),
		Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeAutoLodConfig_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeAutoLodConfig_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
