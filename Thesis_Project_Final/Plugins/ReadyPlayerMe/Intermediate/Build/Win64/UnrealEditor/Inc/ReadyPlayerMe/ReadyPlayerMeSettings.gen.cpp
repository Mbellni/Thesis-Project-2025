...
class UScriptStruct* FRpmAvatarCacheSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RpmAvatarCacheSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings, Z_Construct_UPackage__Script_ReadyPlayerMe(), TEXT("RpmAvatarCacheSettings"));
	}
...
template<> READYPLAYERME_API UScriptStruct* StaticStruct<FRpmAvatarCacheSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAvatarCaching = { "bEnableAvatarCaching", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRpmAvatarCacheSettings), &Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAvatarCaching_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAvatarCaching_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAvatarCaching_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAutomaticCacheCleaning = { "bEnableAutomaticCacheCleaning", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRpmAvatarCacheSettings), &Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAutomaticCacheCleaning_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAutomaticCacheCleaning_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_bEnableAutomaticCacheCleaning_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_CachedAvatarLimit = { "CachedAvatarLimit", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRpmAvatarCacheSettings, CachedAvatarLimit), METADATA_PARAMS(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_CachedAvatarLimit_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewProp_CachedAvatarLimit_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::Struct_MetaDataParams))
	};
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_AppId = { "AppId", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UReadyPlayerMeSettings, AppId), METADATA_PARAMS(Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_AppId_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_AppId_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_bKeepLoadedAvatarsInMemory = { "bKeepLoadedAvatarsInMemory", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UReadyPlayerMeSettings), &Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_bKeepLoadedAvatarsInMemory_SetBit, METADATA_PARAMS(Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_bKeepLoadedAvatarsInMemory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_bKeepLoadedAvatarsInMemory_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_AvatarCacheSettings = { "AvatarCacheSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UReadyPlayerMeSettings, AvatarCacheSettings), Z_Construct_UScriptStruct_FRpmAvatarCacheSettings, METADATA_PARAMS(Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_AvatarCacheSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UReadyPlayerMeSettings_Statics::NewProp_AvatarCacheSettings_MetaData)) }; // 1293474181
	...
	struct Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_Statics::ScriptStructInfo[] = {
		{ FRpmAvatarCacheSettings::StaticStruct, Z_Construct_UScriptStruct_FRpmAvatarCacheSettings_Statics::NewStructOps, TEXT("RpmAvatarCacheSettings"), &Z_Registration_Info_UScriptStruct_RpmAvatarCacheSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRpmAvatarCacheSettings), 1293474181U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReadyPlayerMeSettings, UReadyPlayerMeSettings::StaticClass, TEXT("UReadyPlayerMeSettings"), &Z_Registration_Info_UClass_UReadyPlayerMeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReadyPlayerMeSettings), 1031432824U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_1700065913(TEXT("/Script/ReadyPlayerMe"),
		Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
