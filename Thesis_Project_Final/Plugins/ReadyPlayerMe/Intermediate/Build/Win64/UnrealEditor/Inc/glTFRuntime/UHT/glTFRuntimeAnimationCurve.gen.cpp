...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_RotatorCurves = { "RotatorCurves", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(RotatorCurves, UglTFRuntimeAnimationCurve), STRUCT_OFFSET(UglTFRuntimeAnimationCurve, RotatorCurves), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_RotatorCurves_MetaData), Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_RotatorCurves_MetaData) }; // 4189057203
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UglTFRuntimeAnimationCurve, UglTFRuntimeAnimationCurve::StaticClass, TEXT("UglTFRuntimeAnimationCurve"), &Z_Registration_Info_UClass_UglTFRuntimeAnimationCurve, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UglTFRuntimeAnimationCurve), 1357519415U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_1276696415(TEXT("/Script/glTFRuntime"),
		Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
