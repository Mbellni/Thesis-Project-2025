...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AglTFRuntimeAssetActorAsync_Statics::NewProp_bStaticMeshesAsSkeletal = { "bStaticMeshesAsSkeletal", nullptr, (EPropertyFlags)0x0011000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AglTFRuntimeAssetActorAsync), &Z_Construct_UClass_AglTFRuntimeAssetActorAsync_Statics::NewProp_bStaticMeshesAsSkeletal_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AglTFRuntimeAssetActorAsync_Statics::NewProp_bStaticMeshesAsSkeletal_MetaData), Z_Construct_UClass_AglTFRuntimeAssetActorAsync_Statics::NewProp_bStaticMeshesAsSkeletal_MetaData) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAssetActorAsync_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAssetActorAsync_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AglTFRuntimeAssetActorAsync, AglTFRuntimeAssetActorAsync::StaticClass, TEXT("AglTFRuntimeAssetActorAsync"), &Z_Registration_Info_UClass_AglTFRuntimeAssetActorAsync, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AglTFRuntimeAssetActorAsync), 2389771409U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAssetActorAsync_h_4064097780(TEXT("/Script/glTFRuntime"),
		Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAssetActorAsync_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_UE5_3_BPBlank_53_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAssetActorAsync_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
