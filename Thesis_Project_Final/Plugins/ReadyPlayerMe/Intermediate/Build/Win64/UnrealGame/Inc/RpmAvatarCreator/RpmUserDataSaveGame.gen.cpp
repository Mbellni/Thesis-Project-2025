...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URpmUserDataSaveGame_Statics::NewProp_UserData = { "UserData", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URpmUserDataSaveGame, UserData), Z_Construct_UScriptStruct_FRpmUserData, METADATA_PARAMS(Z_Construct_UClass_URpmUserDataSaveGame_Statics::NewProp_UserData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URpmUserDataSaveGame_Statics::NewProp_UserData_MetaData)) }; // 262635238
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URpmUserDataSaveGame_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_URpmUserDataSaveGame_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_URpmUserDataSaveGame_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_RpmAvatarCreator_Public_RpmUserDataSaveGame_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_RpmAvatarCreator_Public_RpmUserDataSaveGame_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URpmUserDataSaveGame, URpmUserDataSaveGame::StaticClass, TEXT("URpmUserDataSaveGame"), &Z_Registration_Info_UClass_URpmUserDataSaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URpmUserDataSaveGame), 3552976666U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_RpmAvatarCreator_Public_RpmUserDataSaveGame_h_3530053333(TEXT("/Script/RpmAvatarCreator"),
		Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_RpmAvatarCreator_Public_RpmUserDataSaveGame_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_RpmAvatarCreator_Public_RpmUserDataSaveGame_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
