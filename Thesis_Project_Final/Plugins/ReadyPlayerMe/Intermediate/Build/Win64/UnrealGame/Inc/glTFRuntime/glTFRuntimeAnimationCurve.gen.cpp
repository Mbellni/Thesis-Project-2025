...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_QuatCurves_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_QuatCurves;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_RotatorCurves_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_QuatCurves_MetaData[] = {
		{ "ModuleRelativePath", "Public/glTFRuntimeAnimationCurve.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_QuatCurves = { "QuatCurves", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, CPP_ARRAY_DIM(QuatCurves, UglTFRuntimeAnimationCurve), STRUCT_OFFSET(UglTFRuntimeAnimationCurve, QuatCurves), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_QuatCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_QuatCurves_MetaData)) }; // 133266933
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_RotatorCurves_MetaData[] = {
		{ "ModuleRelativePath", "Public/glTFRuntimeAnimationCurve.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_RotatorCurves = { "RotatorCurves", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, CPP_ARRAY_DIM(RotatorCurves, UglTFRuntimeAnimationCurve), STRUCT_OFFSET(UglTFRuntimeAnimationCurve, RotatorCurves), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_RotatorCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UglTFRuntimeAnimationCurve_Statics::NewProp_RotatorCurves_MetaData)) }; // 133266933
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UglTFRuntimeAnimationCurve, UglTFRuntimeAnimationCurve::StaticClass, TEXT("UglTFRuntimeAnimationCurve"), &Z_Registration_Info_UClass_UglTFRuntimeAnimationCurve, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UglTFRuntimeAnimationCurve), 3326604537U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_2036021588(TEXT("/Script/glTFRuntime"),
		Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFRuntimeAnimationCurve_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
