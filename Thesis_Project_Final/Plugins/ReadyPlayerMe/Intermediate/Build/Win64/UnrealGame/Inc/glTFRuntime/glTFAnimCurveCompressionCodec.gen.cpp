...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UglTFAnimCurveCompressionCodec_Statics::NewProp_AnimSequence = { "AnimSequence", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UglTFAnimCurveCompressionCodec, AnimSequence), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UglTFAnimCurveCompressionCodec_Statics::NewProp_AnimSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UglTFAnimCurveCompressionCodec_Statics::NewProp_AnimSequence_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFAnimCurveCompressionCodec_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFAnimCurveCompressionCodec_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UglTFAnimCurveCompressionCodec, UglTFAnimCurveCompressionCodec::StaticClass, TEXT("UglTFAnimCurveCompressionCodec"), &Z_Registration_Info_UClass_UglTFAnimCurveCompressionCodec, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UglTFAnimCurveCompressionCodec), 469290377U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFAnimCurveCompressionCodec_h_2684790878(TEXT("/Script/glTFRuntime"),
		Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFAnimCurveCompressionCodec_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Anmol_ConvaiPlugins_Plugins_ReadyPlayerMe_Source_ThirdParty_glTFRuntime_Public_glTFAnimCurveCompressionCodec_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
